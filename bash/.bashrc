...
# Force hostname to lowercase for the terminal prompt
PROMPT_HOSTNAME="${HOSTNAME,,}"
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@$PROMPT_HOSTNAME\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}\u@$PROMPT_HOSTNAME:\w\$ '
fi
